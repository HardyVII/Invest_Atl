...
uber_df = pd.read_csv('data/processed/UBER_Safety_Post')
marta_df = pd.read_csv('data/processed/Marta_Safety_Post')
beltline_df = pd.read_csv('data/processed/AtlBeltline_Safety_Post')
